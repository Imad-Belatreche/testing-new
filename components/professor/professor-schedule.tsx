              ...
              {assignments.map((assignment) => (
                <div key={assignment.id} className="grid grid-cols-6 p-3 text-sm border-t items-center">
                  ...
                  <div>
                    <Badge
                      variant="outline"
                      className={`${assignment.program === "L1" ? "bg-primary-usthb" : "bg-gray-700"} text-white`}
                    >
                      {assignment.program}
                    </Badge>
                  </div>
                  ...
                  <div>
                    <Badge
                      variant={assignment.role === "Main" ? "default" : "secondary"}
                      className={assignment.role === "Main" ? "bg-primary-usthb" : ""}
                    >
                      {assignment.role}
                    </Badge>
                  </div>
