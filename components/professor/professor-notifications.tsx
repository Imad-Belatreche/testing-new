                        ...
                        <div className="flex justify-end mt-2 gap-2">
                          ...
                          {notification.type === "assignment" && (
                            <>
                              ...
                              <Button size="sm" className="bg-primary-usthb hover:bg-primary-usthb/90">
                                Confirm
                              </Button>
                            </>
                          )}
              ...
              <CardContent className="p-6">
                <div className="mb-4 pb-4 border-b">
                  ...
                  <div className="flex gap-2 text-sm text-muted-foreground">
                    <span>From: University Exam Office &lt;exams@usthb.edu&gt;</span>
                    <span>To: Dr. Smith &lt;john.smith@usthb.edu&gt;</span>
                  </div>
                </div>
                ...
                <div className="flex justify-end mt-6 gap-2">
                  ...
                  <Button className="bg-primary-usthb hover:bg-primary-usthb/90">
