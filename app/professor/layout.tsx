...
import { LayoutDashboard, Calendar, FileText, LogOut, Menu, X, Bell, User } from "lucide-react"
...
export default function ProfessorLayout({ children }: { children: React.ReactNode }) {
  ...
  const navigation = [
    ...
    { name: "My Schedule", href: "/professor/schedule", icon: Calendar },
    { name: "Exam Details", href: "/professor/exams", icon: FileText },
              ...
              <DropdownMenuContent align="end" className="w-80">
                ...
                <div className="max-h-80 overflow-auto">
                  <DropdownMenuItem className="flex flex-col items-start p-3 cursor-pointer">
                    <div className="font-medium">New Surveillance Assignment</div>
                    <div className="text-sm text-muted-foreground">
                      You have been assigned as Main Invigilator for Database Systems exam
                    </div>
